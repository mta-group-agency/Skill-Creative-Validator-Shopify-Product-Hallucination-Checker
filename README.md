...
> Free [Claude Code](https://claude.ai/claude-code) skill by [MTA Digital](https://mta.digital) — built by Marek Ciesla (marek.ciesla@mta.digital)
...
**[MTA Digital](https://mta.digital)** — performance marketing agency specializing in e-commerce growth, paid advertising, and marketing automation.
